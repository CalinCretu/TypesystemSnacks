...
namespace TypesystemSnacks
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                Console.WriteLine("Scegli uno snack da eseguire:");
                Console.WriteLine("1. Trova il maggiore tra due numeri");
                Console.WriteLine("2. Stampa la parola più corta e la parola più lunga tra due parole");
                Console.WriteLine("3. Calcola la somma di 10 numeri inseriti");
                Console.WriteLine("4. Calcola la somma e la media dei numeri da 2 a 10");
                Console.WriteLine("5. Verifica se un numero è pari o stampa il successivo se è dispari");
                Console.WriteLine("6. Verifica se un utente è invitato alla festa del Grande Gatsby");
                Console.WriteLine("7. Crea un array con numeri dispari inseriti dall'utente");
                Console.WriteLine("8. Calcola la somma degli elementi in posizione dispari di un array predefinito");
                Console.WriteLine("9. Continua a chiedere all'utente di inserire numeri fino a quando la somma supera 50");
                Console.WriteLine("10. Genera N array di numeri casuali tra 1 e 100 e li stampa a schermo");
                ...
                Console.WriteLine("Vuoi eseguire un altro snack? (sì/no)");
